...
func (p *Providers) Start(provider Provider) error {
	...
	go p.Current.Start(func(r io.Reader) {
		if err := sendImageToDisplay(r); err != nil {
...
func sendImageToDisplay(rd io.Reader) error {
